  ...
  const generateLocalBusinessSchema = () => {
    return {
      ...
      image: [
        ...
        getAssetPath('/ac-rental-gaur-city.jpg'),
        getAssetPath('/ac-rental-noida-extension.jpg'),
      ],
    ...
    return (
      <>
        <Helmet>
          ...
          <meta property="og:image" content="https://kselectrical.in/ac-rental-gaur-city.jpg" />
